...
echo ""
echo "✅ Setup complete! Now edit wake_server.py (nano wake_server.py) to add your MAC and IP:" 
echo ""
echo "The server should be running on your PC at: http://${LOCAL_IP}:41264" 
